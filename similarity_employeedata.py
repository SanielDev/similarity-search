    ...
    try:
        ...
        def perform_advanced_search(collection, all_items):
            try:
                ...
                print("\n\n Printing the results as it is: \n\n")
                print(results)
                print("\n\n")
                print("\n\n Printing the results['metadatas'] as it is: \n\n")
                print(results['metadatas'])
                print("\n\n")
                # print("\n\n Printing the results['documents'] as it is: \n\n")
                ...
                for i, (doc_id, document, distance) in enumerate(zip(
                    ...
                    metadata = results['metadatas'][0][i]
                    # print("Datatype of metadata is: ", type(metadata))
                    print(f"  {i+1}. {metadata['name']} ({doc_id}) - Distance: {distance:.4f}")
                    print(f"     {metadata['role']} in {metadata['location']} ({metadata['experience']} years)")
                    print(f"     Document snippet: {document[:120]}...")
